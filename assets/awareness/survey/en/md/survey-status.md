...
The purpose of this research is not simply to rearrange existing theoretical assets.
It is to rebuild the question of how awareness can be described in workable units as a new line of inquiry.

The project places neurophenomenology at the center, while also integrating psychology, including developmental psychology, in order to assemble a core structural model of awareness.
The survival-trust axis is treated as a working hypothesis for testing whether it is valid to place survival and intersubjectivity at the center of that model.

## 2. Main Topics

At present, the main topics are the following:

1. A structural model of awareness that can be connected to neurophenomenology
...
The main public materials at present are:
...
The current focus is on the survival-trust axis and the four-layer model.
...
If you want the overall picture first, start with the general guide.
If you want to connect the model to observation, support, or practice, start with the designer guide.
If you want the conceptual comparison in more analytical form, start with the academic guide.
If you want an entry-point list, see the survey index.
