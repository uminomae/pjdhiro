...
date: 2025-06-17T19:30:31+09:00
categories:
  - 量子
  - 民話
tags:
...
回転の平方根が気になる。パウリにトライ。彼の心理はユングの影響で広く知られることとなった。そんな親近感。
<!-- more -->
...
ユングといえば物語。まずは、最も古い神話イザナミ、と最古の文学かぐや姫。和風で。月っぽく。アクエリオンやSAOなどの作品もあるが、ここではまず古典を重視したい。基礎があれば応用は柔軟に対応できると考える。
...
- ひるこをお生み
  - 生成の失敗
    - ☯️陰陽マークの片方だけ
- 次にあわしま
  - ここは言葉遊びになっており、ランダムな点と縞模様が現れる二重スリット実験の失敗を示している。
- 占術による言い直し
  - qVq⁻¹ の正順序への修正
    - 淡路島などの安定生成
...
LLMに問い合わせたところ、「これは正しい？」> [ChatGPT o3の回答](https://chatgpt.com/share/685216fc-fb80-800b-b030-ef42fa884001)  
