...
現場で起きがちなジレンマに「気づく」ための図です。

- 波：
  - 「良い」の自滅：逆側の揺らぎを「悪い」と判断しやすく、「良い」だけを選択して固定してしまう。
- 縁：
  - 意図しない侵略：衝突が弱すぎて関係の強度が生まれず巻き上がらない。結果、均一で平坦になる。
...
- 数学・物理学
  - 複素数：根
    - 波動：虚軸と回転
    - ジュリア集合：根が立ち現れる「縁」や「境界」
  - 場の量子論（QFT）
    - 「場」を基本として粒子は出来事として記述する。  
- 生命・化学・医学・農学
  - 雌雄と子孫
- 心理学
  - M・クライン：対象関係論
