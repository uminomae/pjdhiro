...
- 宗教／仏教
  - 般若心経：色即是空 — 実体視をほどき、現象を関係（縁起）の場として捉える核。 
- 東洋思想
  - 陰陽（陰陽思想） — 二相の相補・循環で、変化／生成を説明する基本フレーム。 道家（老子・荘子）など
- 物理学
  - 場の量子論（QFT） — 粒子より先に「場」を基本として量子化し、相互作用を場のダイナミクスで記述する。  
- 哲学
  - ウィルバー：四象限 — 内/外 × 個/集団の4視点は、現象の還元を防ぐ地図として機能する。 
  - ヘーゲル：弁証法（止揚） — 対立を否定しつつ保存して、より高次へ編み直す運動（束ね直し）。「Aufhebung（止揚）」（※テーゼ/アンチテーゼ/ジンテーゼ）
- 経済学
  - シュンペーター：創造的破壊 — 革新の波が循環を駆動し、新旧の構造が入れ替わる。  
- 経営学
  - 野中郁次郎：Ba（場） — 関係性が創発する共有コンテクストから、知が束ね上がる。  
- 心理学
  - ユング：集合的無意識／元型 — 個を超える心的場から象徴が立ち現れる構図。  
...
- 今年の前半は、「場」と「時代」を考えていて、
  - 視点の一つは、生まれる場所と生み出された現象。原因と結果、卵と鶏のような。
  - その間に細かくいくつか構造と順番が見えた。それは「創造のプロセス」だし、「存在そのもの」だなと。今のところ。
    - [対話：まとめ：場と時代の違いを考えた]({{ '/dialogueBaJidai//' | relative_url }})
- 精神とはなにか、自我とはなにか、といった「主観的」、「心理的」領域に取り組む前に「客観的」、「物質的」なことを整理してから進みたかった。
