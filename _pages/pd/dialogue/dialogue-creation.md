...
意味もわからぬままお葬式で読んでいた「般若心経」は、束ねていく過程で土台として立ち上がり、最後にQFT（場の量子論）の「実体より生成と関係が先に立つ」という見方に重ねて、構造対応（アナロジー）として照らし合わせてきた、という流れでした。
海 → 波 → 潮目 → 渦 → 流　のように海の比喩で整理したいと願ってはいます。ただ、海に寄せると心理現象のイメージが湧かなそうで、まだなんとも。覚えやすく誤解が無いものならラベルはなんでも良いとは思っています。
{: .notice--info}
...
[「群盲象を評す」](https://ja.wikipedia.org/wiki/%E7%BE%A4%E7%9B%B2%E8%B1%A1%E3%82%92%E8%A9%95%E3%81%99)ように交点を差し示せたら、と思っています。似ているものを見つけたら教えてください。
{: .notice--info}

- 宗教/思想
  - 日本神話：[国産み](https://ja.wikipedia.org/wiki/%E5%9B%BD%E7%94%A3%E3%81%BF)
    - イザナミがイザナギが天の御柱の周囲を正しい順序で巡る。
  - 禅：[般若心経](https://sousei.gr.jp/8619/)
    - [色即是空、是諸法空相、不増不減、心無圭礙、顛倒夢想 究竟涅槃](https://koufukuji.yokohama/scripture/8)
  - 陰陽思想
...
- 哲学
  ...
  - シモンドン：固体化？
    - 未調査
- 数学・物理学
  - 複素力学： [ジュリア集合](https://acko.net/blog/how-to-fold-a-julia-fractal/)
    - 平方根の分岐が凝縮して境界が像として立ち現れる
  - 回転群：四元数/パウリ行列 ※波と縁
    - 回転子による共役変換。[v → qvq−1](https://www.youtube.com/watch?v=eWdawLuckus)
  - 場の理論（QFT）
...
[![image]({{ '/assets/images/blog/20251218/CreationImage10.png' | relative_url }})]({{ '/assets/images/blog/20251218/CreationImage10.png' | relative_url }})

- 回転・振幅を理解しようとして気づいたこと
  -  [ジュリア集合](https://acko.net/blog/how-to-fold-a-julia-fractal/)：発散と収束の境界に現れる模様
    - 平方根の二つの値
  - [四元数の回転子、ステレオ投影](https://www.youtube.com/watch?v=eWdawLuckus)、パウリ行列
- 今年の前半は、「場」と「時代」を考えていて、
  - 一つの視点は、生まれる場所と生み出された現象。原因と結果、卵と鶏のような。
    - その間に細かくいくつか構造と順番が見えた。それは「創造のプロセス」だし、「存在そのもの」だなと。今のところ。
      - [対話：まとめ：場と時代の違いを考えた]({{ '/dialogueBaJidai//' | relative_url }})
- この後、精神、意識、自我といった「主観的」・「心理的」領域に取り組む前に「客観的」・「物質的」なことを整理してから進みたかった。[鏡のような存在かもしれない]({{ '/dialogueSpilit//' | relative_url }})ので。
