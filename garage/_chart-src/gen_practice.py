...
def frame(px,py,ti,no):
    o.append('<text x="%d" y="%d" fill="#cdd2dd" font-size="21.8" font-weight="700">%s</text>'%(px,py-30,ti))
    ...
    o.append('<text x="%.1f" y="%d" fill="#6f7686" font-size="15" text-anchor="middle">緩衝帯5m</text>'%(X(px,5)+18,py+13))
    o.append('<text x="%.1f" y="%d" fill="#9aa0aa" font-size="15.8" text-anchor="middle">← 50m →</text>'%(px+PADW/2,py+PADH+15))
    o.append('<text x="%d" y="%.1f" fill="#9aa0aa" font-size="15.8" text-anchor="middle" transform="rotate(-90 %d %.1f)">25m</text>'%(px-11,py+PADH/2,px-11,py+PADH/2))
    o.append('<text x="%d" y="%d" fill="#8ab4e6" font-size="16.5">%s</text>'%(px,py+PADH+34,no))
...
o.append('<text x="%.1f" y="%.1f" fill="#7fe39a" font-size="15.8" text-anchor="middle">定常円</text>'%(X(px,16),Y(py,12.5)+3))
...
o.append('<text x="%.1f" y="%.1f" fill="#9aa0aa" font-size="15.8" text-anchor="middle">発進</text>'%(X(px,9),Y(py,7)))
...
o.append('<text x="%.1f" y="%.1f" fill="#9aa0aa" font-size="15.8" text-anchor="middle">停止</text>'%(X(px,42),Y(py,7)))
...
o.append('</svg>')
open(os.path.join(OUT,"practice-pad.svg"),"w").write("\n".join(o))
print("OK")
